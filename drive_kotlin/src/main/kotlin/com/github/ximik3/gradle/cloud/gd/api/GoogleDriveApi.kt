package com.github.ximik3.gradle.cloud.gd.api

import com.github.ximik3.gradle.cloud.Credential
import com.github.ximik3.gradle.cloud.gd.GoogleDriveUploadItem
...
fun GoogleDriveApi.uploadFile(
    ...
    fun readData(): Int {
        ...
        while (length != GoogleDriveApi.RESUMABLE_UPLOAD_PART_MAX_LENGTH) {
            val readLength = inputStream
                    .read(byteArray, length, GoogleDriveApi.RESUMABLE_UPLOAD_PART_MAX_LENGTH - length)
...
//            .url(item.uploadUrl)
                ...
                .addHeader("Authorization", credential.getAuthentication())
